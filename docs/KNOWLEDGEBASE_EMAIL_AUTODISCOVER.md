...
ORDER (per RFC 6186 + 6764 + K-9 practice):
  ...
  imap.example.com / smtp.example.com, NOT mail.example.com.
...
And: Generic pulled mail.example.com only, never imap./smtp., and CalDAV/
...
====================================================================
- Generic connector used only mail.example.com -> should have tried
  imap.example.com (993) and smtp.example.com (465/587) via SRV/
...
====================================================================
- Reproduce the user's scenario against example.com BEFORE claiming fixed:
  add a Generic account with user@example.com, confirm the client
  discovers imap.example.com:993 and smtp.example.com:465/587,
